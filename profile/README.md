...
-   일자리, 정보 부족, 법률 등 외국인 근로자들이 겪을 수 있는 다양한 문제 해결에 도움
...
-   등록된 기업 채용 공고 조회 페이지
-   직군, 경력, 근무형태, 우대사항 등 세부 내용과 해당 공고와 연관된 채용 공고 확인 가능
...
-   사용자의 현재 위치를 기반으로 인근 외국인 근로자 지원 센터와 병원의 위치 및 상세 정보 확인 가능
-   지도에서각 센터 및 병원 클릭시 해당 위치로 이동

### 📍 일반 검색 페이지

<img src="https://github.com/Co-Labor-Project/demo-repository/blob/main/gif/Search.gif" width="100%" height="100%" />

-   기업 정보, 채용 공고, 기업 리뷰 등을 키워드로 검색 가능
